...
async function runMigrations() {
    try {
        ...
        // Ler os arquivos SQL
        const setupSQL = await readFile(join(__dirname, '../../supabase/migrations/20240128000000_setup_functions.sql'), 'utf8');
        const cleanupSQL = await readFile(join(__dirname, '../../supabase/migrations/20240128000000_cleanup.sql'), 'utf8');
        const schemaSQL = await readFile(join(__dirname, '../../supabase/migrations/20240128000000_initial_schema.sql'), 'utf8');
        const fixSchemaSQL = await readFile(join(__dirname, '../../supabase/migrations/20240311000000_fix_schema.sql'), 'utf8');
        const removeRlsSQL = await readFile(join(__dirname, '../../supabase/migrations/20240311004000_remove_all_rls.sql'), 'utf8');
        // Executar setup
