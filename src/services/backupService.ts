...
export async function createBackup(companyId: string): Promise<{ fileName: string; size: number }> {
  try {
...
export async function restoreBackup(file: File, companyId: string): Promise<void> {
  try {
